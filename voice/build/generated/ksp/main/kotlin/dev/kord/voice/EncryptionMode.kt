...
public sealed class EncryptionMode(
    ...
    @Deprecated(
        message =
                "XSalsa20 Poly1305 encryption is deprecated for Discord voice connections and will be discontinued as of November 18th, 2024. As of this date, the voice gateway will not allow you to connect with one of the deprecated encryption modes. Use 'EncryptionMode.from(\"xsalsa20_poly1305\")' instead if you need to keep using 'EncryptionMode.XSalsa20Poly1305'. The deprecation level will be raised to ERROR in 0.17.0, to HIDDEN in 0.18.0, and this object will be removed in 0.19.0.",
    ...
    @Deprecated(
        message =
                "XSalsa20 Poly1305 encryption is deprecated for Discord voice connections and will be discontinued as of November 18th, 2024. As of this date, the voice gateway will not allow you to connect with one of the deprecated encryption modes. Use 'EncryptionMode.from(\"xsalsa20_poly1305_suffix\")' instead if you need to keep using 'EncryptionMode.XSalsa20Poly1305Suffix'. The deprecation level will be raised to ERROR in 0.17.0, to HIDDEN in 0.18.0, and this object will be removed in 0.19.0.",
    ...
    @Deprecated(
        message =
                "XSalsa20 Poly1305 encryption is deprecated for Discord voice connections and will be discontinued as of November 18th, 2024. As of this date, the voice gateway will not allow you to connect with one of the deprecated encryption modes. Use 'EncryptionMode.from(\"xsalsa20_poly1305_lite\")' instead if you need to keep using 'EncryptionMode.XSalsa20Poly1305Lite'. The deprecation level will be raised to ERROR in 0.17.0, to HIDDEN in 0.18.0, and this object will be removed in 0.19.0.",
