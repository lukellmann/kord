    ...
    entries = [
        ...
        Entry(
            ...
            deprecated = Deprecated(
                """$XSalsa20_DEPRECATION Use 'EncryptionMode.from("xsalsa20_poly1305")' instead if you need to """ +
                    "keep using 'EncryptionMode.XSalsa20Poly1305'. $XSalsa20_OBJECT_DEPRECATION_CYCLE",
                ReplaceWith(
        ...
        Entry(
            ...
            deprecated = Deprecated(
                """$XSalsa20_DEPRECATION Use 'EncryptionMode.from("xsalsa20_poly1305_suffix")' instead if you need """ +
                    "to keep using 'EncryptionMode.XSalsa20Poly1305Suffix'. $XSalsa20_OBJECT_DEPRECATION_CYCLE",
                ReplaceWith(
        ...
        Entry(
            ...
            deprecated = Deprecated(
                """$XSalsa20_DEPRECATION Use 'EncryptionMode.from("xsalsa20_poly1305_lite")' instead if you need """ +
                    "to keep using 'EncryptionMode.XSalsa20Poly1305Lite'. $XSalsa20_OBJECT_DEPRECATION_CYCLE",
                ReplaceWith(
