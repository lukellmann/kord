...
@KordVoice
public class DefaultStreams private constructor(
    ...
    public constructor(voiceGateway: VoiceGateway, udp: VoiceUdpSocket) :
        this(voiceGateway = voiceGateway, udp = udp, nonceStrategy = null, unused = null)

    @Deprecated(
        "$XSalsa20_DEPRECATION Construct a 'DefaultStreams' instance without a 'NonceStrategy' instead. " +
    ...
    ) : this(voiceGateway = voiceGateway, udp = udp, nonceStrategy = nonceStrategy, unused = null)
    ...
    @Deprecated(
        "$XSalsa20_DEPRECATION A 'DefaultStreams' instance can be created without a 'NonceStrategy' in which case " +
            "this function will throw an 'UnsupportedOperationException'. Pass an explicit 'EncryptionMode' instead. " +
