...
import dev.kord.voice.XSalsa20_FUNCTION_DEPRECATION_CYCLE
import dev.kord.voice.io.MutableByteArrayCursor
import dev.kord.voice.io.mutableCursor

@Deprecated(
    "$XSalsa20_DEPRECATION 'XSalsa20Poly1305Codec' is no longer needed. $XSalsa20_CLASS_DEPRECATION_CYCLE",
...
@Deprecated(
    "$XSalsa20_DEPRECATION 'XSalsa20Poly1305Codec' is no longer needed. $XSalsa20_FUNCTION_DEPRECATION_CYCLE",
    level = DeprecationLevel.WARNING,
)
