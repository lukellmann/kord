...
internal abstract class Decrypt {
    ...
    protected fun createDecryptedVoicePacket(headerSize: Int, extensionAndAudio: Buffer): DecryptedVoicePacket {
        ...
        val headerExtension = if (extensionLength >= 0) {
            ...
            for (i in 0..<extensionLength) {
                headerExtension[i] = extensionAndAudio.readUInt()
            }
        ...
        return DecryptedVoicePacket(
            ...
            decryptedAudio = extensionAndAudio, // the extension part was already consumed // TODO handle padding?
        )
    }
}
