...
@Deprecated
@kotlin.Deprecated(
		message = dev.kord.voice.VoiceConnectionKt.XSalsa20_DEPRECATION +
				" If you need an implementation of TweetNaCl, provide your own instead. " +
				dev.kord.voice.VoiceConnectionKt.XSalsa20_CLASS_DEPRECATION_CYCLE,
